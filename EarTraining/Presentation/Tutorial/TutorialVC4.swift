...
final class TutorialVC4: BaseViewController {
    
    // MARK: - View Properties
    
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Tutorial_Title4".localized
    ...
    private let descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = "Tutorial_Description4".localized
    ...
    let nextButton = OliveButton(title: "Done".localized)
