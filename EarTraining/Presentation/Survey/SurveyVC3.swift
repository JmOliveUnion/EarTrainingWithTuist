...
class SurveyVC3: BaseViewController {
    ...
    private let fifthButton: OliveButton = {
        let button = OliveButton(title: "Survey_button5".localized)
        button.isEnabled = false
        return button
    }()
    
    private lazy var buttonStack: UIStackView = {
       let stack = UIStackView(arrangedSubviews: [firstButton, secondButton, thirdButton, fourthButton, fifthButton])
        stack.axis = .vertical
        stack.spacing = 15
